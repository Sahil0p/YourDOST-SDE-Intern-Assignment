...
- This repository contains solutions for all three parts — **DSA Problem**, **Frontend Task**, and **Backend Task**
- Each implemented in separate folders with their own documentation and setup instructions.
...
| ⚙️ **Backend**  | Node.js, Express.js, JSON file storage       |
